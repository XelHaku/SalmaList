    ...
    <div>
        ...
        <table cellpadding="7" cellspacing="7" class="auto-style1" style="width:900PX">
            ...
            <tr>
                ...
                <td class="formBox2" style="width: 180px">
                    <asp:DropDownList ID="DropListOperador" runat="server" DataSourceID="SqlDataSource1" DataTextField="OPERADOR" DataValueField="OPERADOR" Width="250px">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GASTOS_ConnectionString %>" SelectCommand="SELECT [OPERADOR] FROM [UnidadTable] ORDER BY [OPERADOR]"></asp:SqlDataSource>
                </td>
